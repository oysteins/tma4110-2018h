...
\]
Finn $P_{\V v}\V u$. Tegn $\V u$, $\V v$ og $P_{\V v}\V u$ i samme koordinatsystem. 
\end{oppgave}
...
\begin{oppgave}
Bruk minste kvadraters metode på det overbestemte systemet \\[2pt]
\begin{punkt}
$
\begin{amatrix}{2}
2 & 1 & -1 \\
