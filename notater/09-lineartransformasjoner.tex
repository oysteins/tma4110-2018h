...
generell måte, ved å gi en abstrakt definisjon av vektorrom.
Vektorrom er \emph{objektene} vi studerer i lineær algebra.  Men hvis
vi vil %TODO

%  Det er også interessant å se på \emph{funksjoner} mellom
% vektorrom.  En
...
\[
T\left( \vvv{x_1}{x_2} \right) = \vv{x_1 + 2 x_2}{x_1 + 1}
\]
% TODO
\end{ex}
