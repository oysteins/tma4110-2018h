...
\[
\lambda \V x=P\V x=P^2\V x=\lambda^2 \V x.
\]
...
\]
En projeksjonsmatrise har alltid en egenverdi som er 0 og en som er 1. Dette impliserer følgende teoremer.
...
\end{thm}
 ...
 Projeksjonen som isolerer komponenter i retningen $\V{w}$ er 
