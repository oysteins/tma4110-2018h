...
\begin{oppgave}
La $A$ og $B$ være to $2\times 2$-matriser. Betrakt ligningen $$AX=B,$$ hvor $X$ er en ukjent $2\times 2$-matrise.
...
\begin{oppgave}
La $A$, $B$ og $C$ være  $2\times 2$-matriser. Betrakt ligningen $$AX+XB=C,$$ hvor $X$ er en ukjent $2\times 2$-matrise.
...
\begin{punkt}
Løs ligningen når $A$, $B$ og~$C$ er følgende matriser:
\[
A=\begin{bmatrix}
-1 & 1\\
1 & -1
