...
% ga studiet av
% likninger opphav til at man fant opp visse former for matematiske
% strukturer.  Etter hvert ble det oppdaget at mange forskjellige
% strukturer hadde visse grunnleggende egenskaper felles, og at man ofte
% kunne forenkle ting voldsomt ved å se vekk fra detaljene i hver enkelt
% struktur, og kun fokusere på disse grunnleggende egenskapene.  Dermed
% endte man opp med en hel del \emph{abstrakte algebraiske strukturer}
% (noen av de viktigste kalles \emph{grupper}, \emph{ringer} og
% \emph{moduler}).  
...
Men vi vil gjøre vektorbegrepet enda mer generelt.  %% TODO
