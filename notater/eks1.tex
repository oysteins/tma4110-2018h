...
\begin{oppgave}
La $\u = \vv{1}{3}$ og $\v = \vv{1}{-1}$
være vektorer i~$\R^2$.

La $\u_1$ være den ortogonale projeksjonen av $\u$ på~$\v$.
Regn ut $\u_1$, og finn en vektor~$\u_2$ slik at $\u = \u_1 + \u_2$.

Tegn $\u$, $\v$, $\u_1$ og~$\u_2$ i samme koordinatsystem.
\end{oppgave}
...
\begin{oppgave}
Finn en $3 \times 3$-matrise som har egenverdier $3$ og~$-2$,
med tilhørende egenrom henholdsvis
\[
\Sp \left\{ \vvv{1}{2}{-3}, \vvv{1}{3}{-3} \right\}\quad
\quad\text{og}\quad
\Sp \left\{ \vvv{-2}{-4}{8} \right\}.
\]
\end{oppgave}
