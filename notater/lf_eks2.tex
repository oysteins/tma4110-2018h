...
% $y_1 = 1$ og~$y_2 = e^{3t}$ av den homogene likningen.
% Vi får
% \[
% y_1' = 0,
% \qquad
...
% \qquad
% \text{og}\qquad
% y_1 y_2' - y_2 y_1' = 3 e^{3t},
% \]
% og integralene vi trenger i variasjon av parametre blir:
% \begin{align*}
% \int \frac{y_1 \cdot (e^t + 2)}{y_1 y_2' - y_2 y_1'} dt
% &= \int \frac{e^t + 2}{3 e^{3t}} dt
%  = \int \left( \frac{1}{3} e^{-2t} + \frac{2}{3} e^{-3t} \right) dt
%  = -\frac{1}{6} e^{-2t} - \frac{2}{9} e^{-3t} + C
% \\
% \int \frac{y_2 \cdot (e^t + 2)}{y_1 y_2' - y_2 y_1'} dt
% &= \int \frac{3e^{4t} + 6e^{3t}}{3 e^{3t}} dt
%  = \int ( e^{t} + 2 ) dt
%  = e^{t} + 2t + C
% \end{align*}
...
% \begin{align*}
% y_p
% &= y_2 \left( -\frac{1}{6} e^{-2t} - \frac{2}{9} e^{-3t} \right)
%    - y_1 \left( e^{t} + 2t \right) \\
% &= -\frac{1}{2} e^t + \frac{2}{3} - e^t - 2t \\
% &= -\frac{3}{2} e^t + \frac{2}{3} - 2t
% \end{align*}
