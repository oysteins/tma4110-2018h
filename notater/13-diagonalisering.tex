...
\end{bmatrix}.
\]
Dersom $m=n$, har matrisen $V$  en invers $V^{-1}$,
siden $\V{v}_1$, $\V{v}_2\dots \V{v}_n$ er lineært uavhengige. Vi ganger med $V^{-1}$ fra høyre og får
\[
V^{-1}AV=D.
\]
...
\end{align*}
Her har vi brukt at $\lambda_1$ og $\lambda_2$ er reelle Vi vet altså at
\[
